...
Your task:
You don't need to read input or print anything. Your task is to complete the function insertionSort() which takes the head of the linked list, 
sorts the list using insertion sort algorithm and returns the head of the sorted linked list.
        ...
        while(second){
            if(second->data >= first->data){
                ...
                if(head_ref->data >= temp->data){
                    ...
                    Node* help=head_ref;
                    while(help->next->data < temp->data){
                        help=help->next;
                    }
                    temp->next=help->next;
                    help->next=temp;
